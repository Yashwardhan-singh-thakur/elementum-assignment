...
function ProgressSection() {
  return (
    <section
      id="progress"
      className=" relative  h-[605px] overflow-visible bg-white max-[900px]:h-auto max-[900px]:overflow-hidden max-[900px]:py-[90px] max-[600px]:py-[70px]"
    >
      <div className="relative mx-auto h-full w-[min(calc(100%_-_64px),1200px)]  max-[900px]:grid max-[900px]:h-auto max-[900px]:w-[min(calc(100%_-_40px),700px)] max-[900px]:gap-[60px]">
        <div className="absolute top-[46px] left-0 z-[2] size-[450px] max-[1200px]:size-[410px] max-[900px]:relative max-[900px]:top-auto max-[900px]:left-auto max-[900px]:mx-auto max-[900px]:size-auto max-[900px]:w-[min(76vw,460px)] max-[900px]:aspect-square">
          <img
            className="pointer-events-none absolute top-[5px] -left-[15px] z-[1] w-28 w-[162px]"
          ...
          />
          <img
            className="pointer-events-none absolute bottom-3 -right-0 -bottom-6 z-[3] w-[170px]"
            src="/styled-container/pink-triangle.png"
            alt="pink-triangle"
            aria-hidden="true"
          />
        ...
        <div className="absolute top-[145px] left-[678px] z-[2] w-[600px] max-[1200px]:left-[56%] max-[1200px]:w-[44%] max-[900px]:static max-[900px]:ml-auto max-[900px]:w-full max-[900px]:max-w-[620px]">
          <h2 className="m-0 origin-left scale-x-90 font-gerbil text-[40px]  leading-[55px] font-normal tracking-[-0.042em] max-[1200px]:text-5xl max-[900px]:scale-x-100 max-[900px]:text-[clamp(42px,7.5vw,58px)] tracking-wide ">
            <HighlightText
              color="mint"
            ...
            <br />
            help your{" "}
            <UnderlinedText className="after:w-[290px]  after:-translate-x-1/2 after:left-1/2 after:-bottom-[0.14em] after:h-[0.59em]">
              progress
            </UnderlinedText>
          </h2>
